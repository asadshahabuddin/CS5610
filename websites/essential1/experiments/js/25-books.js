/*
    ...
    File: 25-books.js
    Details: JavaScript file for '25-books.html'.
...
function($routeProvider)
{
    ...
    when("/home",
    {
        templateUrl: "../html/books_partials/home-5.html",
        controller: "HomeController"
    }).
    when("/bookmarks",
    {
        templateUrl: "../html/books_partials/bookmarks-5.html",
        controller: "BookmarksController"
    }).
    when("/details/:isbn",
    {
        templateUrl: "../html/books_partials/details-5.html",
...
function($scope, BookService)
{
    ...
    $scope.items = BookService.getItemsCache();
    ...
    $scope.searchBooks = function()
    {
        ...
        function(response)
        {
            ...
            $scope.items = items;
            BookService.setItemsCache(items);
